...
//error_reporting(E_ALL ^ E_NOTICE);
	...
	define('CONFIG_LOGIN_PASSWORD', 'cbm');
	...
	//define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,txt'); //  zero+++
	define('CONFIG_UPLOAD_VALID_EXTS', 'gif,jpg,png,bmp,tif,zip,sit,rar,gz,tar,htm,html,mov,mpg,avi,asf,mpeg,wmv,aif,aiff,wav,mp3,swf,ppt,rtf,doc,docx,pdf,xls,txt,xml,xsl,xlsx,dtd');// zero+++
