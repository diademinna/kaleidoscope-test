...
<div class="ibox-content">
    <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input name="date_end" id="date_end" class="form-control" type="text" value="{$data.date_end}" />
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea name="text_product" class="tiny">{$data.text_product}</textarea>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <div id="photo">
                    {if $data.ext}
                        <a href="/uploaded/actions/{$data.id}_sm.{$data.ext}" target="_blank"><img src="/uploaded/actions/{$data.id}_sm.{$data.ext}" class="photo" /></a>
