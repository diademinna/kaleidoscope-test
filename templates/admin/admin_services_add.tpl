{capture name="content_name"}
	Услуги / {if $data.name}Редактировать - {$data.name}{else}Добавить{/if}
{/capture}
    ...
    <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <div id="photo">
                    {if $data.ext}
                        <a href="/uploaded/services/{$data.id}_sm.{$data.ext}" target="_blank"><img src="/uploaded/services/{$data.id}_sm.{$data.ext}" class="photo" /></a>
