...
<?php if (!is_callable('smarty_modifier_string_format')) include 'D:\Programms\OpenServer\OpenServer\domains\kaleidoscope-test.ru\req\external\smarty\plugins\modifier.string_format.php';
if (!is_callable('smarty_modifier_escape')) include 'D:\Programms\OpenServer\OpenServer\domains\kaleidoscope-test.ru\req\external\smarty\plugins\modifier.escape.php';
if (!is_callable('smarty_modifier_debug_print_var')) include 'D:\Programms\OpenServer\OpenServer\domains\kaleidoscope-test.ru\req\external\smarty\plugins\modifier.debug_print_var.php';
?><?php ob_start(); ?>
