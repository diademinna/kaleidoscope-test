<?php /* Smarty version Smarty3-b7, created on 2015-07-17 12:24:59
         compiled from ".\templates\admin/admin_services_add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2909455a8c9eb46ac39-73848212%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b91721426988e36bf32324ca37232d5a11dfa60b' => 
    array (
      0 => '.\\templates\\admin/admin_services_add.tpl',
      1 => 1437124945,
    ),
  ),
  'nocache_hash' => '2909455a8c9eb46ac39-73848212',
  'function' => 
  array (
  ),
...
<?php ob_start(); ?>
	Услуги / <?php if ($_smarty_tpl->getVariable('data')->value['name']){?>Редактировать - <?php echo $_smarty_tpl->getVariable('data')->value['name'];?>
...
<div class="ibox-title">
    <h5>Форма для добавления / редактирования услуги</h5>
</div>
...
" />
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label">Изображение (превью): <br /> 290 х 190 - верт.</label>
            <div class="col-sm-10">
                <input  type="file" name="image" />
                <br /><br />
                <div id="photo">
                    <?php if ($_smarty_tpl->getVariable('data')->value['ext']){?>
                        <a href="/uploaded/services/<?php echo $_smarty_tpl->getVariable('data')->value['id'];?>
_sm.<?php echo $_smarty_tpl->getVariable('data')->value['ext'];?>
" target="_blank"><img src="/uploaded/services/<?php echo $_smarty_tpl->getVariable('data')->value['id'];?>
_sm.<?php echo $_smarty_tpl->getVariable('data')->value['ext'];?>
" class="photo" /></a>
