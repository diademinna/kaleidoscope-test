<?php /* Smarty version Smarty3-b7, created on 2015-07-15 15:41:52
         compiled from ".\templates\admin/admin_portfolio_photo_add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:895955a65510181940-80080120%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd8414b07da2a7b9f5bf8fd2823e441ad71ef2c18' => 
    array (
      0 => '.\\templates\\admin/admin_portfolio_photo_add.tpl',
      1 => 1436964106,
    ),
  ),
  'nocache_hash' => '895955a65510181940-80080120',
  'function' => 
  array (
  ),
...
<?php ob_start(); ?>
 ...
 echo $_template->getRenderedTemplate();?><?php $_template->updateParentVariables(0);?><?php unset($_template);?>
        ...
        <table class="edit" width="100%">
            <tr>
                <td width='150px'><a href="/admin/portfolio/list/<?php echo $_smarty_tpl->getVariable('page')->value;?>
/<?php if ($_smarty_tpl->getVariable('get_param')->value){?><?php echo $_smarty_tpl->getVariable('get_param')->value;?>
<?php }?>" ><span></span><i class="fa fa-hand-o-left"></i> К СПИСКУ ПОРТФОЛИО</a><br><br></td>
                <td>
            ...
            <tr>
                <td></td>
                <td>
                    <input type="hidden" name="id_portfolio" id="id_portfolio" value="<?php echo $_smarty_tpl->getVariable('id_portfolio')->value;?>
" />
	...
	<script type="text/javascript">
            ...
            window.onload = function() {
                    ...
                    var settings = {
                            ...
                            upload_url: "/admin/portfolio_photo/add/<?php echo $_smarty_tpl->getVariable('page')->value;?>
/<?php echo $_smarty_tpl->getVariable('id_portfolio')->value;?>
/?swfupload=1",
                            //post_params: { "id_from_swfupload": '<?php echo $_smarty_tpl->getVariable('id_portfolio')->value;?>
'},
...
">
                            <form id="form_item_<?php echo $_smarty_tpl->getVariable('id_portfolio')->value;?>
" name="form_img_<?php echo $_smarty_tpl->getVariable('id_portfolio')->value;?>
" action="" method="post">
                                <div class='row'>
                                    <div class='col-sm-4'>
                                        <div class="padd">
                                            <a href="/uploaded/portfolio/<?php echo $_smarty_tpl->getVariable('cur')->value['id_portfolio'];?>
/<?php echo $_smarty_tpl->getVariable('cur')->value['id'];?>
.<?php echo $_smarty_tpl->getVariable('cur')->value['ext'];?>
" target="_blank"><img src="/uploaded/portfolio/<?php echo $_smarty_tpl->getVariable('cur')->value['id_portfolio'];?>
/<?php echo $_smarty_tpl->getVariable('cur')->value['id'];?>
...
" class="photo" /></a>
                                            <img class="pointer" src="/img/admin/del.png" onclick="del('<?php echo $_smarty_tpl->getVariable('cur')->value['id_portfolio'];?>
','<?php echo $_smarty_tpl->getVariable('cur')->value['id'];?>
